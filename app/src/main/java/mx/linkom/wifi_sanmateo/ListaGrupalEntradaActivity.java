...
public class ListaGrupalEntradaActivity extends mx.linkom.wifi_sanmateo.Menu implements View.OnClickListener {
   ...
   // Handler handler;
    ...
    public void invitados() {
        String URL = "https://sanmateoresidencial.mx/plataforma/casetaV2/controlador/WIFI_SM/vst_gru_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
